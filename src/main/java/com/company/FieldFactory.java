...
public final class FieldFactory {
    ...
    public static  GUI_Field[] makeGUIFields() {
        ...
        fields[i++] = new GUI_Street("The Werewall", "-80/extra turn", "10", "", Color.WHITE, Color.BLUE);
    ...
    public static  Field[] makeFields() {
        ...
        fields[i++] = new Field(6, "Walled city", "YAY!You managed to climb over the walls and enter the walled city! A bystander gives you 180 coins for your amazing climbing skills", 180, false);
        ...
        fields[i++] = new Field(10, "The Werewall", "AUUUU! You tried chasing a werewolf but accidentally ran into a wall and loose 80 coins, but don't worry you get to roll again", -80, true);
        fields[i++] = new Field(11, "The pit", "OH dang! You just dropped 50 coins in the pit and cant get it back", -50, false);
        fields[i++] = new Field(12, "Goldmine", "PARTY TIME!! You dug out a gold nugget and sold it for 650 coins", 650, false);
